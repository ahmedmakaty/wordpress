...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2015 at 03:37 PM
...
(331, 'relevanssi_doc_count', '6', 'yes'),
...
CREATE TABLE IF NOT EXISTS `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1862 ;
...
(549, 81, '_edit_lock', '1433430940:1'),
