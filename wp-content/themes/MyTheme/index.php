...
<?php putRevSlider( "slider" ) ?>
  ...
  <div class="CS1">
    <div class="container">
      ...
      <div class="row ">
        <div class="col-md-6 col-sm-8 col-sm-offset-3 col-md-offset-0 wow fadeInLeft">
        ...
        <div class="col-md-6 col-sm-8 col-sm-offset-3 col-md-offset-0 col-xs-8 col-xs-offset-3  ">
          <div class="wow fadeInDown"><h1 >Heading</h1>
          <h2 > Sub-heading goes here </h2>
          </div>
          <div class="wow fadeInUp">
          <div class="row liststyle">
            <ul class="col-md-6 col-xs-12 col-sm-12 clearfix">
  ...
  <section class="CS2">
      ...
      <div class="row">
    <div class="container">
        <div class="col-md-offset-2 col-md-8 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-3 ">
          <div class="CS21">
            <h1 class="MS CS32H">
              Manufactureres Of 
            </h1>
      ...
      <div class="row CS22">
        ...
        <?php if(have_posts()) : ?>
        <div class="PSCS col-md-offset-3 col-md-6  col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-3">
                  <div id="owl-demo">
